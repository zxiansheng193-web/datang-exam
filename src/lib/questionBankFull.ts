...
export const questionBankFull: QuestionBank = {
  ...
  reception: [
    ...
    // 情景题（1题，5分）
    { type: 6, question: "情景题：一位客户早上9点将车送来维修，承诺下午3点取车。下午2:50客户准时到店，但维修师傅说配件还没到，需要再等2小时。客户非常生气，要求投诉。作为服务顾问，你应该如何处理这种情况？", answer: "处理步骤：①立即道歉，承认失误，安抚客户情绪；②了解具体情况，确认配件到达时间；③给出明确解决方案：如免费提供代步车、上门取车、赠送优惠券等；④如客户同意等待，提供舒适的休息环境和饮品；⑤安排专人跟进配件到货进度；⑥维修完成后，立即通知客户；⑦交付时再次道歉，表示感谢；⑧后续跟进客户满意度；⑨反思内部流程，避免类似情况再次发生。", score: 5, explanation: "" },
  ],
